...
const PackageElement = (args) => {
    const package_path = path.join('./packages/development/', args.package_name);
    const package_manifest = JSON.parse(fs.readFileSync(path.join(package_path, 'manifest.json')));
